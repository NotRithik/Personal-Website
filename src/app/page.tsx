...
export default function Home() {
  return (
    <div className="h-screen w-full grid-overlap-container">
      <CustomCursor />
      <div className="custom-cursor-reveal-layer h-full w-full grid-overlap-container grid-overlap-element z-50">
      ...
      <div className="select-none main-content-layer h-full w-full z-10 px-[9%] py-[3%] grid-overlap-element landing-page-content-grid bg-black text-white">
